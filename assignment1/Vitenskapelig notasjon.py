...
print('Hvilket stoff er det du har?')
stoff = input()
print('Hva er molvekta for ' + stoff + ' i granm?')
molvekt = int(input())
print('Hvor mange gram ' + stoff + ' har du?')
mengde = int(input())

molekylmengde = avogadro * (mengde / molvekt)

print('Du har ', format(molekylmengde, '.1e'), 'molekyler ' + stoff)
...
print('Hvor mange 10-toners melodilinjer har du hørt?')
heard = int(input())
percentage = (heard / maxMelody) * 100
print('Du har hørt', percentage, 'prosent av alle mulige melodier')

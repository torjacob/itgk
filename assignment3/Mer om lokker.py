...
tries = 0
brukerSvar = ""
riktigSvar = "California"

while brukerSvar != riktigSvar:
    brukerSvar = input("I hvilken stat ligger byen Fresno? ")
    tries += 1

print("Stemmer:) Du brukte ", tries, " forsøk")

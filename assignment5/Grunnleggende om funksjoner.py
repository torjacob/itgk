...
if svar == fasit:
    ...
    print("Feil, det var", fasit)
'''  
# Valgte å flytte alt inn i en funksjon - følte det ga mer mening slik
### TILLEGG 3 kommer her...
def gradboy(grad):
    adj = input("Skriv inn et adjektiv: ")
    svar = input("Hva er " + grad + " for " + adj + "?")
    if grad.lower() == "komparativ":
        fasit = komparativ(adj)
    elif grad.lower() == "superlativ":
        fasit = superlativ(adj)
    else:
        print("U done somethin' wrong here brutha")
    if svar == fasit:
        print("Korrekt!")
    else:
        print("Feil, det var", fasit, "faktisk!")

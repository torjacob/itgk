...
# Svar: Om den oppdaterte verdien til gravity trengs videre fra dette tidspunktet i koden er dette en god ide. Om det derimot bare skal brukes denne ene gangen eller begrenset innenfor et område vil det heller være lurt å lage en egen (global) variabel som GRAVITY_MOD eller noe liknende. Dette så man ikke mister baseline, og andre funksjoner ødelegges.
